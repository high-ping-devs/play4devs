    ...
    return (
      <div>
        ...
        <div className='flex flex-col mx-5'>
          ...
          <span className='text-gray text-sm mb-4'>{dadosPlaylist?.tracks.total} faixas</span>
          <a href={dadosPlaylist?.external_urls.spotify} target='_blank' className='flex gap-1 text-sm hover:underline'>Ouvir no Spotify <img src="/assets/Redirect.svg" alt="Redirecionar" /></a>
        </div>
